...
export interface ModalProps {
  ...
  /** Se false, clicar no backdrop NÃO fecha o modal. Padrão: true */
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          <div
            className={cn(
              "fixed inset-0 z-[101] flex pointer-events-none overflow-hidden",
              isBottomSheet
          ...
          >
            ...
            >
              ...
              {/* Body — scrollável */}
              <div className="flex-1 overflow-y-auto overflow-x-hidden overscroll-contain w-full p-5 sm:p-7 relative scroll-smooth min-w-0">
